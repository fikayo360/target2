    ...
    return (
        <section id="hero">
           { navActive? (<div id='navMobile' onClick={toggleMobileNav} ref={ref} className={`${inView?'animate__animated animate__fadeInDown animate__slow animate__delay-4s':''}`}>
            ...
            <div id='heroOther'>
                <h5 id='heroTxt' ref={ref} className={`${inView?'animate__animated animate__rubberBand animate__slow':''}`}>Allison marrie photography </h5>
                <div id='heroOtherBottom'>
                <p>i am a photographer with a passion for capturing genuine moments in a creative way.
                    Explore my galllery, lets create something beautiful together</p>
